...
### Equation 5.1: Girder Depth ($G_d$, in) — $R^2 = 0.1941$
...
### Equation 5.2: Lateral Spacing Between Girders ($S$, ft) — $R^2 = 0.5274$
...
### Equation 5.3: Number of Girders ($N_g$, count) — $R^2 = 0.5628$
...
### Equation 5.4: Bottom Flange Bottom Depth ($P$, in) — $R^2 = 0.0323$
...
### Equation 5.5: Bottom Flange Bottom Width ($Q$, in) — $R^2 = 0.2566$
...
### Equation 5.6: Prestressing Strands Per Girder ($N_s$, count) — $R^2 = 0.8530$
...
### Equation 5.7: Harping Position ($H_p$, ft) — $R^2 = 0.3481$
...
$$
G_{d,min}(L) = 0.045 \times L \times 12 = 0.54 L \quad \text{(inches for } L \text{ in ft)}
$$
